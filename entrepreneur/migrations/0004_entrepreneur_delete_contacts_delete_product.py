...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('entrepreneur', '0003_product_provider'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='factory.factory_contacts', verbose_name='Поставщик')),
            ],
            options={
