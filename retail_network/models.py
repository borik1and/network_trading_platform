...
class Retail_network_contacts(models.Model):
    retail_network_name = models.CharField(max_length=100, default='', verbose_name='Название завода')
...
class Retail_network_product(models.Model):
